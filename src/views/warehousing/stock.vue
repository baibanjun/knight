<template>
  <div>
    <h3 style="margin-left:5%;">
      ...
      <el-button type="warning" icon="el-icon-plus" @click="add(1)">新增入库记录</el-button>
      <el-button type="success" icon="el-icon-plus" @click="add(2)">新增出库记录</el-button>
    </h3>
    <el-table
      :data="list"
      border
    ...
    >
      ...
      <el-table-column label="出入库时间" width="160">
...
export default {
    ...
    return {
      ...
      list: [
        //出入库列表
        {
          ...
          recycleType: 2,
          inOutType: 1,
          plate_number: "川A67876",
          driver: "张三丰啊",
          phone: "13566676767",
          rough_weight: 90000,
          rough_weight_number:'1号地沟油',
          tare_weight: 500000,
          tare_weight_number:'2号大红油',
          net_weight: 0
        }
      ]
    };
  ...
  methods: {
    ...
    add: function(_type) {
      if(_type == 1){
        this.$router.push("/warehousing/addDayIn")
      }
      else{
        this.$router.push("/warehousing/addDayOut");
      }
